...
JSON_FILENAME = f"{PROFILE_VERSION}.json"
CSV_FILENAME = f"{PROFILE_VERSION}.csv"
...
def main(argv: list[str] | None = None) -> int:
    ...
    paths = write_reports(payload, output_dir=_resolve_path(args.output_dir, repo_root=repo_root))
    print(paths["json"])
    print(paths["csv"])
    return 0
