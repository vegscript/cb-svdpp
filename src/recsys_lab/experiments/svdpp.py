...
from recsys_lab.models.registry import SVDppAdapter, validate_model_config_payload
from recsys_lab.models.svdpp import SVDppConfig
...
def _build_svdpp_config(
    *,
    ...
    _, profile = validate_model_config_payload(model_config_payload, expected_model_name="svdpp")
    return SVDppAdapter.build_model_config(
        profile,
