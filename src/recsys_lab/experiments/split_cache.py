...
def resolve_split_cache_policy(
    *,
    ...
    return SplitCachePolicy(
        ...
        effective_use_cache=False,
        decision_reason=f"auto_disable_no_positive_evidence_split_family",
    )
...
def _expected_manifest_payload(
    *,
    ...
    return {
        ...
        "source_manifest_path": repo_path_string(data_source_manifest_path(processed_manifest_path), repo_root=repo_root),
        "source_fingerprint": {
