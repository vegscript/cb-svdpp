...
def run_cb_svdpp_experiment(
    *,
    ...
    command_string = command or (
        ...
        f"{training_index_cache_fragment}"
        ...
        try:
            ...
            with stage_profiler.stage(
                ...
                split_result = load_or_build_split_cache(
                    ...
                    repo_root=root,
                    runtime_config_payload=runtime_config_payload,
                    build_split=lambda: _build_cb_svdpp_split(
            ...
            with PeakMemoryMonitor() as memory_monitor:
                ...
                with stage_profiler.stage(
                    ...
                    training_index_stage["cache_status"] = history_index_result.metadata.cache_status
                ...
                with stage_profiler.stage(
                    ...
                    cluster_history_result = load_or_build_user_cluster_history_index(
                        ...
                        repo_root=root,
                        runtime_config_payload=runtime_config_payload,
                        train_fingerprint=history_index_result.metadata.train_fingerprint,
            ...
            caches_payload = {
                "training_user_history": {
                    "enabled": use_training_index_cache,
                    "status": history_index_result.metadata.cache_status,
                    "manifest": repo_path_string(history_index_result.metadata.cache_manifest_path, repo_root=root),
                    "cache_root": repo_path_string(history_index_result.metadata.cache_root, repo_root=root),
            ...
            metrics_payload: dict[str, Any] = {
                ...
                "model": {
                    ...
                    "training_index_cache": {
                        ...
                        "user_cluster_history": {
                            **caches_payload["user_cluster_history"],
                        },
                    },
                    "clustering": {
