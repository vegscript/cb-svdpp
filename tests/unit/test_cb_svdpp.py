...
def test_cb_svdpp_numba_kernel_matches_python_reference(monkeypatch: MonkeyPatch) -> None:
    data = RatingsData(
    ...
    def make_model() -> CBSVDppRecommender:
    ...
    monkeypatch.setattr(cb_svdpp_module, "train_cb_svdpp_epoch_numba", fail_kernel)
