...
from recsys_lab.experiments.performance import StageProfiler, build_system_metrics, estimate_numpy_payload_nbytes
...
def test_stage_profiler_records_stage_timing_memory_and_metadata() -> None:
