...
def test_run_precomputed_index_reuse_benchmark_writes_valid_artifacts(
    ...
    assert (
        summary["models"]["svdpp"]["variants"]["reference_rebuild_indices"]["warmup"]["precomputed_index_reuse"]
        is False
    )
    assert (
        summary["models"]["svdpp"]["variants"]["optimized_reuse_precomputed_indices"]["warmup"][
